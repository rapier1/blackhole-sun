			...
			<div id="navbar" class="collapse navbar-collapse">
				...
				<p class="navbar-right navbar-btn">
					<button id="userManagement"
						onClick="window.location='http://<?php echo $_SERVER['SERVER_NAME']?>/blackholesun/usermanagement.php'"
						type="button" class="btn btn-sm btn-primary">Users</button>
				</p>
				<p class="navbar-right navbar-btn">
					<button id="newCustomer"
						onClick="window.location='http://<?php echo $_SERVER['SERVER_NAME']?>/blackholesun/newcustomer.php'"
						type="button" class="btn btn-sm btn-primary">New Customer</button>
				</p>
				<p class="navbar-right navbar-btn">
					<button id="routeList"
						onClick="window.location='http://<?php echo $_SERVER['SERVER_NAME']?>/blackholesun/routes.php'"
						type="button" class="btn btn-sm btn-primary">Route List</button>
				</p>
				<p class="navbar-right navbar-btn">
					<button id="logout"
