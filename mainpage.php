...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top">
		...
		if ($_SESSION['bh_user_role'] == 4) {
		    print "<p class='navbar-right navbar-btn'><button id='management' onClick=\"window.location='http://" . $_SERVER['SERVER_NAME'] ."/blackholesun/management.php'\"  type='button' class='btn btn-sm btn-primary'>Managment</button></p>";
		}
		?>
